...
import { BrainCircuit, BriefcaseBusiness, MapPin, Network, Tag, UserPlus, Wallet } from "lucide-react"
            ...
            <section id="ofertas" className="bg-muted/30 py-10 sm:py-12 lg:py-16">
                <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                        {ofertasDummy.map((oferta) => (
                            <Card key={oferta.id} className="rounded-2xl py-4 shadow-none gap-3">
