      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-3 px-4 sm:gap-6 sm:px-6">
        <Link href="/" className="group flex min-w-0 items-center gap-3">
          {resolvedLogoSrc ? (
            ...
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary text-primary-foreground text-xs font-semibold shadow-soft transition-transform duration-[240ms] group-hover:scale-105">
              {resolvedCompanyName.slice(0, 2).toUpperCase()}
            </div>
          )}
          <span className="truncate font-[family-name:var(--font-display)] text-lg font-semibold tracking-tight">
            {resolvedCompanyName}
          </span>
        </Link>
              ...
              <div className="mt-8 flex flex-col gap-2 px-4">
                ...
                <div className="mt-3 flex flex-col gap-2 border-t border-border/60 pt-3">
                  {!isAuthResolved ? (
                    ...
                    <>
                      <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-background/70 px-3 py-2">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="truncate text-xs text-muted-foreground">{user.email || "usuario@ejemplo.com"}</p>
                        </div>
                      </div>
                      <SheetClose asChild>
                        <Link href="/mi-perfil" className="flex items-center gap-2 rounded-xl px-3 py-2 text-sm font-medium text-muted-foreground transition-colors duration-[240ms] hover:bg-muted/90 hover:text-foreground">
                    ...
                    <SheetClose asChild>
                      <Button asChild className="w-full rounded-full shadow-elevated">
