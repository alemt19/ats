...
export const CandidateSchema = z.object({
	...
	dress_code: DressCodeSchema.nullable().default('casual'),
	collaboration_style: ColaborationStyleSchema.nullable().default('mixed'),
	work_pace: WorkPaceSchema.nullable().default('moderate'),
	level_of_autonomy: LevelOfAutonomySchema.nullable().default('balanced'),
	dealing_with_management:
		DealingWithManagementSchema.nullable().default('friendly_and_approachable'),
	level_of_monitoring: LevelOfMonitoringSchema.nullable().default('weekly_goals'),
