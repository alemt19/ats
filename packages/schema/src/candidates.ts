...
export const CandidateSchema = z.object({
	...
	dress_code: DressCodeSchema.nullable(),
	collaboration_style: ColaborationStyleSchema.nullable(),
	work_pace: WorkPaceSchema.nullable(),
	level_of_autonomy: LevelOfAutonomySchema.nullable(),
	dealing_with_management: DealingWithManagementSchema.nullable(),
	level_of_monitoring: LevelOfMonitoringSchema.nullable(),
